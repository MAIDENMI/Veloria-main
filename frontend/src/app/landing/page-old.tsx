        ...
        <div className="max-w-4xl mx-auto text-center">
          <BlurFade delay={0.1}>
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 tracking-tight">
              Meet <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Veloria</span>
            </h1>
          </BlurFade>
          
          <BlurFade delay={0.2}>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              The AI therapist that understands you. Available 24/7 for personalized mental health support.
            </p>
          </BlurFade>
          ...
          <BlurFade delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-0 shadow-xl px-8 py-4 text-lg"
